...
(function() {
                    ...
                    setTimeout(function() {
						...
						if( a.length > 0 ){
						  for(i=0; i<a.length;i++){
							mf = confmap.home+'modules/'+a[i]+'.js';
							oa( mf );
    ...
    md.getTilesUrl = function(a, b, c) {
		...
		var tdir = confmap.roadmap.length>0?confmap.roadmap:confmap.home + "roadmap";
		return tdir + "/" + b + "/" + e + "/" + a +"."+ confmap.format; // 使用本地的瓦片
	}
    ;
    var La = new id("\u5730\u56fe",md,{
        tips: "\u663e\u793a\u666e\u901a\u5730\u56fe",
...
//        var tdir = confmap.satellite.length > 0 ? confmap.satellite : confmap.home + "satellite";//修改 使用本地卫星的瓦片 
//        //修改 使用本地卫星的瓦片 
//        return tdir + "/" + b + "/" + c + "/" + e +"."+ confmap.format;
    }
    ;
    var Qa = new id("\u4e09\u7ef4",nd,{
        tips: "\u663e\u793a\u4e09\u7ef4\u5730\u56fe",
    ...
    od.getTilesUrl = function(a, b) {
       ...
       // return (jd[Math.abs(c + e) % jd.length] + "u=x=" + c + ";y=" + e + ";z=" + b + ";v=009;type=sate&fm=46&udt=" + Sb("satellite")).replace(/-(\d+)/gi, "M$1")
        ////修改 使用本地卫星的瓦片 
        var tdir = confmap.satellite.length > 0 ? confmap.satellite : confmap.home + "satellite";
       return tdir + '/' + b + '/' + c + '/' + e + '.jpg';
    }
    ;
    var Ya = new id("\u536b\u661f",od,{
        tips: "\u663e\u793a\u536b\u661f\u5f71\u50cf",
